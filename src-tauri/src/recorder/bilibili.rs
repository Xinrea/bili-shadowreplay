...
use super::stream::{Stream, StreamType};
use crate::api::bilibili::RoomInfo;
use crate::api::errors::ApiError;
use crate::api::{bilibili::BiliClient, bilibili::UserInfo};
                    ...
                    *self.last_update.write().await = Utc::now().timestamp();
                    ...
                    if *self.last_update.read().await < Utc::now().timestamp() - 10 {
                        ...
                        return Err(RecorderError::FreezedStream {
                            stream_info: current_stream.to_string(),
                        });
                    }
                }
